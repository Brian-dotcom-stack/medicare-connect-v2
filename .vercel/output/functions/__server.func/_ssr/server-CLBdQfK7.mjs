...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-BqGC1dqa.mjs";
...
import { i as requestHandler, r as getResponse, t as createMiddleware } from "./createMiddleware-DZKjvFNc.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DPfJY9c9.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CltlZHwK.mjs"),
		import("./start-DAY8r_oI.mjs"),
